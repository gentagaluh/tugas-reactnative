...
const Lunas =({navigation})=>{
  return(
    ...
    <CustomButton wd={70} bg="rgba(255, 0, 0, 0.1)" fw='bold' tx="All Siswa" txcolor="red" op={() => navigation.navigate('All')} ml={10} mt={10}/>
    <CustomButton bg="lightgreen" fw='bold' tx="Siswa Lunas" txcolor="green" op={() => navigation.navigate('Lunas')} ml={10} mt={10}/>
    </View>
